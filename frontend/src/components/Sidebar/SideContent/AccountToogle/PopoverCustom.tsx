        ...
        <div className="absolute top-12 right-1 z-[100]">
            {isPopoverVisible && (
                ...
                >
                    ...
                    {/* Menu Items */}
                    <div className="px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer flex items-center gap-2">
                    ...
                    <div className="px-4 py-2 hover:bg-red-100 dark:hover:bg-red-900 cursor-pointer flex items-center gap-2 text-red-600 dark:text-red-400">
